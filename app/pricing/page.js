            ...
            {[
              {
                ...
                a: 'We use the formula: (views × 0.5) + (likes × 2) + (comments × 5). Comments are weighted highest because they signal strong engagement.',
              },
              {
                q: 'How often is the data updated?',
                a: 'The pipeline runs once daily via GitHub Actions, fetching the top 50 trending YouTube videos in the US.',
              },
              {
                q: 'What payment methods are accepted?',
                a: 'We use Dodo Payments, which supports MoMo card, credit/debit cards, and other local payment methods.',
              },
              {
                q: 'Can I cancel my Pro subscription?',
                a: 'Yes, you can cancel anytime from your account settings. You keep Pro access until the end of your billing period.',
              },
            ].map(({ q, a }) => (
